package com.kirby.runanjing.lite.fragment.preference;
		...
		switch (preference.getKey())
		{
			case "star":
				try
				{
					...
					star .setData(Uri.parse("market://details?id=com.kirby.runanjing.lite"));
			...
			case "github":
				...
				github.setData(Uri.parse("https://github.com/nihaocun/Kirby-Assistant-Lite"));
